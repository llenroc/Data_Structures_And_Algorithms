...
namespace _04_How_To_Solve_Coding_Problems
{
    class Program
    {
        /* 051 Google-Interview-Video: https://www.youtube.com/watch?v=XKu_SEDAykw */
        /* 053 containsCommonItem: https://repl.it/@aneagoie/containsCommonItem */
        /* 054 Interview_Answer_in_Javascript_Google_Question: https://repl.it/@aneagoie/Google-Question */

        #region [Interview Cheat Sheet]
        /*  
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            isFound = hasPairWithSum_LinearTime(array1);
            isFound = hasPairWithSum_LinearTime(array2);
        ...
        static bool hasPairWithSum_QuadraticTime(int[] array)  // Big O: O(n * n) or O(n^2) --> Quadratic Time
        {
            bool isFound = false;
            ...
            for (int i = 0; i < array.Length; i++) // O(n)
            {
                ...
                {
                    Console.WriteLine("{0} + {1} = {2}", array[i], array[j], array[i] + array[j]);

                    if(array[i] + array[j] == sum)
                    {
                        Console.WriteLine("Found: {0} + {1} = {2}", array[i], array[j], array[i] + array[j]);
                        isFound =  true;
                        break;
                    }
                }
        ...
        static bool hasPairWithSum_LinearTime(int[] array)  // Big O: O(n) --> Linear Time
        {
            bool isFound = false;
            ...
            for (int i = 0; i < array.Length; i++) // O(n)
            {
                ...
                Console.WriteLine("{0} + {1} = {2}", array[i], array[length], array[i] + array[length]);

                if (array[i] + array[length] == sum)
                {
                    Console.WriteLine("Found: {0} + {1} = {2}", array[i], array[length], array[i] + array[length]);
                    isFound = true;
                    break;
                }
                else if (array[i] + array[length -1] == sum)
                {
                    Console.WriteLine("Found: {0} + {1} = {2}", array[i], array[length - 1], array[i] + array[length - 1]);
                    isFound = true;
                    break;
                }
                else
        ...
        static bool hasPairWithSum_Hashtable(int[] arr, int sum)
        {
